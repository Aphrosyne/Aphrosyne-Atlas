    ...
    <PageTransition>
      <div className="flex flex-1 flex-col items-center justify-center px-4">
        <div className="flex w-full max-w-lg flex-col items-center gap-3">
          {/* Brand card */}
          <div className="w-full rounded-xl border border-border bg-surface/70 p-5 text-center">
          ...
          <div className="grid w-full grid-cols-3 gap-3">
            {actions.map((action) => (
              <Link
                key={action.label}
                href={action.href}
                className="group flex flex-col items-center gap-2 rounded-xl border border-border bg-surface/70 p-4 text-center transition-all duration-200 hover:-translate-y-0.5 hover:border-accent/50 hover:shadow-sm"
              >
          ...
          {latest && (
            <Link
              ...
              className="group w-full rounded-xl border border-border bg-surface/70 p-4 transition-all duration-200 hover:-translate-y-0.5 hover:border-accent/50 hover:shadow-sm"
            >
